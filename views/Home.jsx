        ...
        return (
            <DefaultLayout title={"home page"}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', fontFamily: 'system-ui' }}>
                    ...
                    <img style={{ height: '500px', width: '500px' }} src="https://cld.accentuate.io/556258820183/1643028424583/Website-TutorialPhotos-FebruaryQuadOne-LookTwo-thumbnail.jpg?v=0&options=w_800" alt="" />
                </div>
